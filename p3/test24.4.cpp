...
int main() { /* 4 pages of physical memory in the system */
    ...
    if (fork()) { // parent
        ...
        vm_yield();
        page7[3] = 'l';
        char* filename1 = page7 + 65535;
        char* page10 = (char*)vm_map(filename1,1);
        vm_yield();
        page10[5] = 'b'; 

    } else { // child
       char* page11 = (char*) vm_map(nullptr, 0);
       page11[5] = 'b';
       vm_yield();
       char* filename3 = page7 + 65535;
       char* page12 = (char*)vm_map(filename3,1);
       page8[2] = 'b'; 
